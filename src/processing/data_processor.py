...
class Processor:
    ...
    def run_pipeline(config):
        ...
        # Clean data
        fraud_df = data_cleaner.handle_missing_values(fraud_df, 'ip_address',
        ...
        ip_to_country = data_cleaner.convert_ip_to_int_columns(ip_to_country, 'lower_bound_ip_address',
                                                               'lower_bound_ip_address_int')
        ip_to_country = data_cleaner.convert_ip_to_int_columns(ip_to_country, 'upper_bound_ip_address',
        ...
        X_fraud, y_fraud, preprocessor_fraud, fraud_base_features = data_transformer.prepare_fraud_data_for_modeling(
            fraud_df)
        X_cc, y_cc, preprocessor_cc, cc_base_features = data_transformer.prepare_creditcard_data_for_modeling(
            creditcard_df)
        ...
        def preprocess(X, y, preprocessor, base_features, name):
            ...
            # Get transformed feature names for SHAP
